...
public class Menu {
	...
	public void loggedMenu(Account account) {
		...
		while (true) {
			...
			System.out.println("7 - Join community");
			System.out.println("8 - Show communities");
			System.out.println("9 - Create community");
			System.out.println("10 - Manage members of my communities");
			System.out.println("11 - Send message to communities");
			System.out.println("12 - Recover data");
			System.out.println("13 - Send message to feed");
